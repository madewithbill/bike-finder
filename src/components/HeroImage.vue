...
import roadImg from '../assets/images/road-bike-hero.avif'
import mtbImg from '../assets/images/mtb-bike-hero.avif'
import cityImg from '../assets/images/city-hybrid-bike-hero.avif'
</script>
